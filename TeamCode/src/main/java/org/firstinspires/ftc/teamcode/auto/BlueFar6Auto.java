...
@Autonomous(name="BlueFar6Auto", group=("comp"))
public class BlueFar6Auto extends LinearOpMode {
    ...
    public static BlueFar6Auto.PIDFConfiguration PIDFParams = new BlueFar6Auto.PIDFConfiguration();
