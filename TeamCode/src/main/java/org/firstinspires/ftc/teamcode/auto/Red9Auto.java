...
@Autonomous(name = "Red 9 + 3 CLEAR", group = "Autonomous")
@Configurable // Panels
public class Red9Auto extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(128.748, 114.617, Math.toRadians(0)));
...
//        public PathChain clearRamp;
        ...
        public Paths(Follower follower) {
            ...
            preLoad = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(128.748, 114.617),

                                    new Pose(110.654, 110.467)
            ...
            firstPickup = follower.pathBuilder().addPath(
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(128.477, 83.645),
                                    new Pose(120.743, 78.425),
                                    new Pose(129.729, 73.505)
                            )
            ...
            secondPickup = follower.pathBuilder().addPath(
                    ...
                    .addPath(
                            new BezierCurve(
                                    new Pose(135.981, 58.991),
                                    new Pose(114.987, 60.500),
                                    new Pose(129.600, 73.505)
                            )
                    ).setConstantHeadingInterpolation(Math.toRadians(0))
