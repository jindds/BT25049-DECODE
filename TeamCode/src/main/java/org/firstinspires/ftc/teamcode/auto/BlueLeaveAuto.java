...
@Autonomous(name = "Blue FAR LEAVE", group = "Autonomous")
@Configurable // Panels
public class BlueLeaveAuto extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(62.355, 7.402, Math.toRadians(180)));
    ...
    public class Paths {
        ...
        public Paths(Follower follower) {
            leave = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(62.355, 7.402),

                                    new Pose(30.953, 7.402)
                            )
